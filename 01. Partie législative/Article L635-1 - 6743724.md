...
613-7 sont calculées, dans la limite d'un plafond fixé par décret, sur la base de tranches de revenu d'activité déterminées
par décret. Chaque tranche est affectée d'un taux de cotisation. Un décret peut prévoir, sous certaines conditions, que ces
